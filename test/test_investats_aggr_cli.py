...
def test_save_data():
    data = [
        ...
        {'datetime': dt(2020, 2, 12, tzinfo=tz.utc),
         ...
         'AAA:chkpt_yield': 0.7 - 1, 'AAA:chkpt_apy': 0.7**(365 / 31) - 1,
         'AAA:global_yield': -0.125, 'AAA:global_apy': 0.875**(365 / 31) - 1,
         'AAA:latest_cgt': 0.15,
         ...
         'BBB:tot_src': 1900, 'BBB:tot_dst': 30, 'BBB:avg_rate': 190 / 3,
         'BBB:tot_dst_as_src': 2100,
         'BBB:chkpt_yield': 1.4 - 1, 'BBB:chkpt_apy': 1.4**(365 / 31) - 1,
         'BBB:global_yield': 7 / 19 * 3 - 1, 'BBB:global_apy': (7 / 19 * 3)**(365 / 31) - 1,
         'BBB:latest_cgt': 0.20,
         'BBB:chkpt_gain_src': 200, 'BBB:chkpt_gain_net_src': 160,
         'BBB:tot_gain_src': 200, 'BBB:tot_gain_net_src': 160,

         'chkpt_yield': 0.05, 'chkpt_apy': 1.05**(365 / 31) - 1,
         'global_yield': 0.05, 'global_apy': 1.05**(365 / 31) - 1},
        ...
        {'datetime': dt(2020, 3, 12, tzinfo=tz.utc),
         ...
         'AAA:tot_src': 1450, 'AAA:tot_dst': 19.25, 'AAA:avg_rate': 1450 / 19.25,
         'AAA:tot_dst_as_src': 3850,
         'AAA:chkpt_yield': 20 / 7 - 1, 'AAA:chkpt_apy': (20 / 7)**(365 / 29) - 1,
         'AAA:global_yield': 20 / 145 * 19.25 - 1, 'AAA:global_apy': (20 / 145 * 19.25)**(365 / 60) - 1,
         'AAA:latest_cgt': 0.15,
         ...
         'BBB:tot_src': 2150, 'BBB:tot_dst': 34.25, 'BBB:avg_rate': 2150 / 34.25,
         'BBB:tot_dst_as_src': 6850,
         'BBB:chkpt_yield': 20 / 7 - 1, 'BBB:chkpt_apy': (20 / 7)**(365 / 29) - 1,
         'BBB:global_yield': 20 / 215 * 34.25 - 1, 'BBB:global_apy': (20 / 215 * 34.25)**(365 / 60) - 1,
         'BBB:latest_cgt': 0.20,
         'BBB:chkpt_gain_src': 4500, 'BBB:chkpt_gain_net_src': 3600,
         'BBB:tot_gain_src': 4700, 'BBB:tot_gain_net_src': 3760,

         'chkpt_yield': 705 / 315, 'chkpt_apy': (1 + 705 / 315)**(365 / 29) - 1,
         'global_yield': 7.1, 'global_apy': 8.1**(365 / 60) - 1},
    ]
