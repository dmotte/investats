...
def test_save_data() -> None:
    ...
    csv = '\n'.join((
        ...
        #
        '2020-03-12 00:00:00+00:00,29.0,60.0,500,3600,10700.0,7050.0,5767.5,7100.0,5800.0,'
        ...
        '29.0,60.0,250,4.25,200,2150,34.25,62.77372262773723,6850.0,1.8571428571428572,547587.0028295065,2.186046511627907,1150.9943403101925,0.2,4500.0,3600.0,4700.0,3760.0,'
...
def test_aggregate_series() -> None:
    ...
    # Ensure that the input data has been prepared correctly
    assert pfmt(named_series_orig) == pfmt({
        'AAA': [
            {'datetime': dt(2020, 1, 12, tzinfo=tz.utc),
             'diff_days': 0, 'tot_days': 0,
    ...
    assert pfmt(named_series) == pfmt(named_series_copy)
